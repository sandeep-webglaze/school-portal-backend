...
let FacilityRepository = class FacilityRepository extends repository_1.MongoRepository {
    constructor(entity) {
        super(entity);
        this.entity = entity;
    }
...
exports.FacilityRepository = FacilityRepository = __decorate([
    ...
    __param(0, (0, mongoose_2.InjectModel)(facility_entity_1.FacilityModel.name)),
