...
let NewsletterRepository = class NewsletterRepository extends mongoDb_repository_1.MongoRepository {
    constructor(entity) {
        super(entity);
        this.entity = entity;
    }
...
exports.NewsletterRepository = NewsletterRepository = __decorate([
    ...
    __param(0, (0, mongoose_2.InjectModel)(newsletter_entity_1.NewsletterModel.name)),
