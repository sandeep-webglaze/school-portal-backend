...
let AuthorRepository = class AuthorRepository extends mongoDb_repository_1.MongoRepository {
    constructor(entity) {
        super(entity);
        this.entity = entity;
    }
...
exports.AuthorRepository = AuthorRepository = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(author_entity_1.AuthorModel.name)),
