...
exports.WalletsModule = WalletsModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([wallet_entity_1.WalletModel])],
        controllers: [wallets_controller_1.WalletsController],
        providers: [wallet_repository_1.WalletRepository, wallets_service_1.WalletsService],
