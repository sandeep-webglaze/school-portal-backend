...
const school_classification_repository_1 = require("./school-classification.repository");
...
exports.SchoolClassificationModule = SchoolClassificationModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [school_classification_repository_1.SchoolClassificationRepository, school_classification_service_1.SchoolClassificationService],
        imports: [mongoose_1.MongooseModule.forFeature([school_classification_entity_1.SchoolClassificationModel]), caching_config_1.CachingModule],
        exports: [school_classification_service_1.SchoolClassificationService]
    })
